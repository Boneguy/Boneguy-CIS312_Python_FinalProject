...
print (' 1. Combine raw Shrimp, lemon, and lime juice in bowl. Cover and refrigerate for at least 1 hour. Ensure Shrimp is covered completely by juice.\n 2. Dice Red Onion, Cucumber, Tomatoes, Jalapeno and Cilantro and mix in separate bowl.\n 3. Add Shrimp and chopped Avocados to vegetables.\n 4. Add Worcestershire, Salt, Pepper to taste.\n 5. Mix well and serve on Tostadas. ')

print ( str (amountShrimp) + ' lbs Shrimp' )
print ( str (amountOnion) + ' Onion(s)' )
print ( str (amountCucumber) + ' Cucumber(s)' )
print ( str (amountTomatoes) + ' Tomato(es)' )
print ( str (amountCilantro)  + ' bundle(s) Cilantro' )
print ( str (amountLime) + ' cups Lime Juice' )
print ( str (amountLemon) + ' cups Lemon Juice' )
print ( str (amountWorcestershire) + ' cups Worcestershire Sauce' )
print ( str (amountAvocado) + ' Avocado(s)' )
print ( str (amountTostadas) + ' bags of Tostadas' )

if spicyInput == spicyTest_y or spicyInput == spicyTest_Y or spicyInput == spicyTest_yes:
	print ( str (amountJalapeno) + ' Jalapeno(s)' )
